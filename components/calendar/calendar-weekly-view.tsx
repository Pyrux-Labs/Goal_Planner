...
import { getDateKey, buildSortedEventsMap } from "@/lib/date-utils";
import Top from "@/components/layout/top";
import CalendarWeeklyColumn from "@/components/calendar/calendar-weekly-column";
import { useToggleEvent } from "@/hooks/use-toggle-event";
...
export default function CalendarWeeklyView({
    ...
    // Reference day for the title: second visible day (position of "today" in the initial layout)
    ...
    // Notify parent when the reference day's month changes
    ...
    // refDay is a new object on every render; use its primitive values as deps
    // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [refDay.getFullYear(), refDay.getMonth(), onMonthChange]);

    // Notify parent when mobileDay crosses a month boundary (mobile)
    ...
    return (
        ...
        >
            <div className="w-full">
                ...
                {/* Desktop: 4-day view */}
                <div className="hidden md:block bg-deep-bg rounded-lg overflow-visible mx-auto">
