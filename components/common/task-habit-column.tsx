...
import TaskHabitSimpleView from "@/components/common/task-habit-simple-view";
		...
		<div className="flex flex-col items-center">
			...
			<div className="flex items-center gap-2 my-4 md:my-6 w-full max-w-[33rem]">
				<div className="bg-input-bg rounded-3xl flex items-center justify-center w-8 h-8 md:w-10 md:h-10">
					{isTask ? (
						<Clock className="w-4 h-4 md:w-5 md:h-5 text-vibrant-orange" />
					) : (
						<Sparkles className="w-4 h-4 md:w-5 md:h-5 text-vibrant-orange" />
					)}
				</div>
			...
			{!showAddForm ? (
				<button
					...
					<div className="w-7 h-7 md:w-8 md:h-8 border-2 border-vibrant-orange rounded-full flex items-center justify-center">
						<Plus className="w-3 h-3 md:w-3.5 md:h-3.5 text-vibrant-orange" />
					</div>
