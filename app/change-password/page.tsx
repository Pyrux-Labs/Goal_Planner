...
function ChangePasswordContent() {
	...
	useEffect(() => {
		// Supabase redirects with ?error=... when the link fails (e.g. expired)
		...
		// Same client for onAuthStateChange and updateUser, as per the official docs
	...
	const handleSubmit = async () => {
		...
		try {
			// Same client that received PASSWORD_RECOVERY, as per the official docs
